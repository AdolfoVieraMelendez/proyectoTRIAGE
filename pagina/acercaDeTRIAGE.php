    ...
    <div class="container-fluid contenedor">
        ...
        <div class="contenedor-pan col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class=""><a href="../pagina/evaluacion.php">Evaluación del Paciente</a></li>
            </ol>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                <!-- <img class="imgContainer" draggable="false" src="../imagenes/niveles.png" alt="Niveles de Triage"> -->
                <div class="row">
                    <div class="formulario animated slideInLeft col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <iframe width="" height="" src="https://www.youtube.com/embed/IQBBKcCR8NU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div> 
        </div>
